...
HUD_HELP_PLAYER_CONTROLS_GasMask;^
HUD_HELP_PLAYER_CONTROLS_NightVision;^
...
HUD_HELP_WEAPON_HANDHELD_GHOOK_CONTROLS_useGH;^
HUD_HELP_WEAPON_HANDHELD_GHOOK_CONTROLS_useGrapplingHookUp;^
HUD_HELP_WEAPON_HANDHELD_HANDGRENADE_CONTROLS_flashbang;^
...
HUD_HELP_WEAPON_HANDHELD_ZLINE_CONTROLS_useZipLine;^
...
set "baseDir=C:\Users\%USERNAME%\Documents\Battlefield 2\Profiles"
for /d %%D in ("%baseDir%\*") do (
    if exist "%%D\General.con" (
        echo Writing to: %%D\General.con
        for %%i in (%lines%) do (
            echo GeneralSettings.setPlayedVOHelp "%%i" >> "%%D\General.con"
        )
    )
)
